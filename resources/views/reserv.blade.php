...
<head>
    ...
    <style>
        ...
        * {
        ...
        .search-bar, .filters, .results-grid, .-card, .-header, .-content, .-info, .product-info, .action-btns, .reserve-btn, .map-btn, .product-details, .product-header, .product-image, .product-title, .product-category, .product-description, .availability-map, .map-container, .tab-buttons, .tab-btn, .tab-content, .-list, .-list-item, .-details, .-actions, .distance, .bottom-nav, .nav-item, .nav-icon, .screens, .screen, .screen-title {
