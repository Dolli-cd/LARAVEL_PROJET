...
class ProduitController extends Controller
{
    ...
    public function ajouter_pro_traitement(Request $request){
        ...
        return redirect()->route('ajouter_pro')->with('confirmer','Le produit a bien été ajouté');
    }
    ...
    public function update_pro($id){
        ...
        if (!$produits) {
            return redirect()->route('liste_pro')->with('erreur', 'Produit non trouvé');
        }
    ...
    public function update_pro_traitement(Request $request){
        ...
        return redirect()->route('update_pro',$produit->id)->with('confirmer','Produit a bien été modifié');
    }
    ...
    public function delete_pro($id){
        ...
        return redirect()->route('liste_pro')->with('confirmer',"Produit $Complet a bien été supprimé ");
    }
}
